package ch.fhnw.woipv.nbody.buildTree;
...
import ch.fhnw.woipv.nbody.boundsReduction.BoundingBoxReduction;
...
public class BuildTreeTest {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 8 * (numberOfNodes + 1) - 1; i > NUMBER_OF_BODIES; i -= 8) {
			System.out.print(numNodes-- + ": " + "[" + child[i - 7] + ", " + child[i - 6] + ", " + child[i - 5] + ", " + child[i - 4] + ", " + child[i - 3] + ", " + child[i - 2] + ", " + child[i - 1] + ", " + child[i - 0] + "]");
			System.out.println();
		}
