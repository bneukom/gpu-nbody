...
__kernel void sort(
	...
	__global int* _blockCount, __global int* _bodyCount,  __global float* _radius, __global int* _bottom, __global float* _mass, __global int* _child, __global volatile atomic_int* _start, __global int* _sorted) {
